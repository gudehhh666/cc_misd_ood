...
parser.add_argument('--rate', type=float, default=0.7, metavar='R', help='rate of the dataset')
...
def main():
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        file_path = model_dir + '/{}-{}-fine-tune.csv'.format(args.model, args.dataset)
        ...
        if epoch % args.save_freq == 0:
            torch.save(model.state_dict(), os.path.join(model_dir, f'model_{epoch}_fine_tuning_{args.trials}.pth'))
